...
极简: while not game.is_over(): await god.act('继续主持本轮'). 兜底超时.
...
async def play_game(god: God, state: GameState, max_rounds: int = 10) -> dict:
    """跑一局直到 game over.
    ...
    Returns:
        {winner, rounds_played, ended_normally, iterations}
    """
    iterations = 0
